            ...
            <div className="main-container">
                ...
                {!showResult
                    ? <>
                        ...
                        <div className="cards">
                            ...
                            <div className="card">
                                <p>Briefly explain this cicept: urben planning</p>
                ...
                <div className="main-buttom">
                    ...
                    <p className="bottom-info">
                        Gemini may display inaaccurate information, including about people, so double-check its responses. Your privacy and Gemini Apps
                    </p>
                </div>
            </div>
        </div>
